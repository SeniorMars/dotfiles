# Generated by Powerlevel10k configuration wizard on 2020-12-05 at 20:38 EST.
...
() {
 ...
 typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=242
  # Default prompt symbol.
  ypeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='❯❯'
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='l'     # default foreground
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      where="${grey}${(V)VCS_STATUS_LOCAL_BRANCH}"
  ...
  # These settings are used for respositories other than Git or when gitstatusd fails and Powerlevel10k has to fall back to using vcs_info.
